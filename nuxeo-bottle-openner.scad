...
difference(){
    scale([2.5, 2.5, 2.5])translate([0])import("/home/tiry/Downloads/Coin_Op_with_a_bit_of_a_Handle.stl", convexity=3);
   #translate([25,-3,15])rotate([0,0,25])scale([0.4, 0.4, 0.4])nuxeo();
}
